fn main() {
    let input = std::fs::read_to_string("inputs/day1/input.txt")
    ...
    let result:usize = input.lines()
        .map(|line| {
            let first = ["one","1","two","2","three","3","four","4","five","5","six","6","seven","7","eight","8","nine","9"]
                .iter()
                .enumerate()
                ...
                .unwrap().1;
            let last = ["one","1","two","2","three","3","four","4","five","5","six","6","seven","7","eight","8","nine","9"]
                .iter()
                .enumerate()
                .fold(None, |acc, (idx, word)| {
                    let digit = (idx / 2) + 1;
